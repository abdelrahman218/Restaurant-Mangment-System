...
public void start(Stage primaryStage) {
    ...
    Image im = new Image("file:G:\\MIU semster 3\\OOP\\project\\Resturant\\open.jpg");
    ...
    start.getStylesheets().add("/system/styles.css");  
...
//"    -fx-background-repeat: no-repeat;");
        Image im = new Image("file:G:\\MIU semster 3\\OOP\\project\\Resturant\\loging.jpg");
    BackgroundImage bgi = new BackgroundImage(
    im,
     BackgroundRepeat.NO_REPEAT,
    BackgroundRepeat.NO_REPEAT,
     BackgroundPosition.CENTER,
        ...
        LogInScene.getStylesheets().add("/system/styles.css");
...
private void Recep_details(Stage nested,Admin current){
    ...
    root.setBackground(bg);
    Scene s= new Scene(root);
    s.getStylesheets().add("/system/styles.css");  
    nested.setScene(s);
...
private void guestPreferencesMenu(Stage mainWindow,Receptionist current){
    ...
    root.setBackground(bg);
        ...
        guestPrefScene.getStylesheets().add("/system/styles.css");
...
private void cancelReservationMenu(Stage mainWindow,Receptionist current){
    ...
    root.setBackground(bg);
        ...
        cancelResScene.getStylesheets().add("/system/styles.css");
...
private void createReservationMenu(Stage mainWindow,Receptionist current){
    ...
    root.setBackground(bg);
        ...
        crResScene.getStylesheets().add("/system/styles.css");
...
private void recepOptions(Stage mainWindow,Receptionist current){
        ...
        images.add(new ImageView(new Image("file:G:\\MIU semster 3\\OOP\\project\\Resturant\\take_reservation.jpg")));
        images.add(new ImageView(new Image("file:G:\\MIU semster 3\\OOP\\project\\Resturant\\reservation.jpg")));
        images.add(new ImageView(new Image("file:G:\\MIU semster 3\\OOP\\project\\Resturant\\guest icon.png")));
    ...
    layout.setBackground(bg);
        ...
        optionsScene.getStylesheets().add("/system/styles.css");
